<template>
    <div>
      ...
      <form @submit.prevent="updateJob">
        ...
        <input type="date" v-model="job['date de création']" required />
  ...
  export default {
    ...
    methods: {
      fetchJob() {
        ...
        // Simuler une récupération d'emploi depuis une source de données
        const jobs = [
          {
            id: 1,
      ...
      updateJob() {
        // Simuler la mise à jour d'un emploi
        console.log("Emploi mis à jour :", this.job);
        this.$router.push('/');
      },
    },
  };
